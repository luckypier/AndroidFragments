...
import course.examples.fragments.staticlayout.FragmentProgrammaticDynamicTitles.ListSelectionListener;

/**
 * Created by precuay on 08/07/15.
 */
public class ActivityProgrammaticDynamic extends Activity implements
        ListSelectionListener {

    public static String[] mTitleArray;
    public static String[] mQuoteArray;

    private final FragmentProgrammaticDynamicQuotes mQuoteFragment = new FragmentProgrammaticDynamicQuotes();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programmaticdynamic);
        ...
        fragmentTransaction.add(R.id.title_fragment_container,
                new FragmentProgrammaticDynamicTitles());
